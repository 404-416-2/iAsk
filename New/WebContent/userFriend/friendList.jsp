			...
			<div id="content">
				...
				<form
					...
					<div class="input-group">
						<input type="text" name="searchFriend"
							class="form-control bg-light border-0 small" placeholder="查找好友"
				...
				<div class="container-fluid" style="width: 60%;">
					...
					<div
						...
						<a href="<%=path %>/ToPersonEdit"
							class="btn btn-warning btn-icon-split"> <span
							class="icon text-white-50"> <i
								class="fas fa-exclamation-triangle"></i>
						</span> <span class="text">修改个人信息</span>
						</a>
					</div>
							...
							<div class="card border-left-primary shadow h-100 py-2">
								<div class="card-body">
									<div class="row no-gutters align-items-center">
										<div class="col mr-2">
											<div
												class="font-weight-bold text-primary text-uppercase mb-1">性别</div>
							...
							<div class="card border-left-success shadow h-100 py-2">
								<div class="card-body">
									<div class="row no-gutters align-items-center">
										<div class="col mr-2">
											<div
												class="font-weight-bold text-success text-uppercase mb-1">年龄</div>
							...
							<div class="card border-left-warning shadow h-100 py-2">
								<div class="card-body">
									<div class="row no-gutters align-items-center">
										<div class="col mr-2">
											<div
												class="font-weight-bold text-warning text-uppercase mb-1">简述</div>
					...
					<%int i =1; %>
					<c:forEach var="friendId" items="${friendList }"
								...
								<div class="card shadow mb-4">
									<div class="card-header py-3">
										<h6 class="m-0 font-weight-bold text-primary">
											<img class="img-profile rounded-circle"
												src="https://source.unsplash.com/QAB-WJcbgJk/60x60">
											好友${friendCount.count } <a
												class="btn btn-danger btn-circle btn-sm"
												href="<%=path%>/DeleteFriend?friendId=${friendId}"> <i
												class="fas fa-trash"></i>
											</a>
										</h6>
									</div>
									<div class="card-body">好友id号:${friendId }</div>
								</div>
							</a>
						</div>
