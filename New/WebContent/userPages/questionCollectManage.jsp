		...
		<div id="content-wrapper" class="d-flex flex-column">
			...
			<div id="content">
				...
				<nav
					...
					<h1 class="h3 mb-0 text-gray-800">我的收藏</h1>
					...
					<form
						...
						action="searchCollect" method="get">
						<div class="input-group">
							<input type="text" name="keys"
								class="form-control bg-light border-0 small" placeholder="查找收藏"
								...
								<form class="form-inline mr-auto w-100 navbar-search"
									...
									<div class="input-group">
										<input type="text" name="keys"
											...
											placeholder="查找收藏" aria-label="Search"
				...
				<div class="container-fluid" style="width: 60%;">
					...
					<!-- Page Heading -->
					<div align="left">
						<button class="btn button-info">收藏列表 (数量: ${collectNum})</button>
					</div>
					<div class="card shadow mb-4">
						<div class="card-body">
							<div class="row">
								...
								<div class="col-lg-1" align="center">回答人数</div>
								<div class="col-lg-2" align="center">更新时间</div>
								<div class="col-lg-2" align="center">分类</div>
								<div class="col-lg-1" align="center">操作</div>

							</div>
						</div>
					</div>

					<c:forEach var="Q" items="${mycollection}">
						<!-- Basic Card Example -->
						...
						<div class="card shadow mb-4">
							<div class="card-body">
								<div class="row">
									<div class="col-lg-2" align="center">${Q.usrId}</div>
									<div class="col-lg-4" align="center">${Q.quesText}</div>
									<div class="col-lg-1" align="center">${Q.follow}</div>
									<div class="col-lg-2" align="center">${Q.subTime}</div>
									<div class="col-lg-2" align="center">${Q.category}</div>
								...
								<form method="get" action="deleteCollect"
											...
											<div class="modal-content">
												...
												<div class="modal-body">
													...
													<form class="form-horizontal" role="form">
														将被删除的收藏ID为: <br> <input type="text" name="q_id"
