	...
	<div class="header" id="header">
		<nav class="navbar" role="navigation" style="height: 105px">
			<div class="navbar-header">
				<img class="tubiao" src="../images/biao.jpg" width="100"
					height="100" alt="图标">
			</div>
			...
			<div class="container problemDetails">
				<div class="row block">
					<div class="col-sm-2 block-avatar">
						<img class="avatar" src="../images/defaultTouxiang.jpg" alt="头像"
					...
					<div class="col-sm-10 block-content">
						...
						<div class="row rightCol">
							...
							<div class="col-xs-6">
								<a
									href="<%=basePath%>/userPages/questionEdit.jsp?q_id=<%=rs.getInt("q_id")%>"><button
										id="answer" class="btn btn-info btn-sm"
										style="<%= u_id == -1 ? "display:none":"" %>">我要回答</button> </a>
							</div>
						</div>
					</div>
				</div>
			...
			<div class="container problemDetails">
				<div class="row block2">
					<div class="col-md-2 block-avatar">
						<img class="avatar" src="../images/profile.jpg" alt="头像"
							width="100" height="100" />
					</div>
						...
						<div class="row center col-md-10 block-content">
							<div>
								<div style="float: left">
									<p style="color: black"><%=rs4.getString("usr_account") %>：
									</p>
								</div>
								<div style="float: left">
									<p>
										<%=rs3.getDate("ans_time") %>
										<%=rs4.getString("school") %></p>
								</div>
							</div>
