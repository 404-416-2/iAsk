            	...
            	<tr>
                	...
                	<td>${Q.ans_text}</td>
                 	...
                 	<td style="padding: 10px;">
                    	<a href="deleteAnswer?q_id=${Q.q_id}&u_id=${Q.u_id}"><button class="delete" onclick="del(this)">删除</button></a>
                    	<a href="userPages/updateAnswer.jsp?q_id=${Q.q_id}&u_id=${Q.u_id}"><button class="update" >修改</button></a>
                 	</td>
            	</tr>
            </c:forEach>
            </tbody>
