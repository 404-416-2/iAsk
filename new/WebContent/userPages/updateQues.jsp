		...
		<div id="content-wrapper" class="d-flex flex-column">
			...
			<div id="content">
				...
				<nav
					...
					<h1 class="h3 mb-0 text-gray-800">编辑问题</h1>
				...
				<div class="container-fluid" style="width: 60%;">
					...
					<form class="form" action="/New/UpdateQues" method="post"
						...
						<div class="card shadow mb-4">
							<div class="card-body">
								...
								<div class="row">
									<div class="col-lg-3">问题类别:</div>
										<div class="col-lg-9">
											<input type="text" name="cate"
												value=<%=request.getParameter("cate")%> readonly="readonly">
										</div>
									</div>
								<br>
								...
								<div class="row">
									...
									<div>
										<input type="text" name="update_text"
											value=<%=request.getParameter("q_tx")%>
