...
<body id="page-top" style="background: #f8f9fc; margin-bottom: 10%">
								...
								<form class="form-inline mr-auto w-100 navbar-search"
									...
									<div class="input-group">
										<input type="text" name="keys"
											...
											placeholder="查找好友" aria-label="Search"
				...
				<div class="container-fluid" style="width: 60%;">
					...
					<div
						...
						<button class="btn btn-info" data-toggle="modal"
							data-target="#myModal">添加回答</button>
					</div>

					<form method="get" action="AddAnswer" class="form-horizontal"
					...
					</form method="get" action="addCollect" class="">
					...
					<!-- Page Heading -->
					<div align="left">
						<button class="btn button-info">问题详情</button>
					</div>
					<div class="card shadow mb-4">
						<div class="card-body">
							<div class="row">
								<div class="col-lg-2" align="center">问题ID: ${ques.quesId}</div>
								<div class="col-lg-3" align="center">所属人: ${ques.usrId}</div>
								<div class="col-lg-7" align="center">问题内容: ${ques.quesText}
								</div>
							</div>
						</div>
					</div>
					...
					<div align="left">
						<button class="btn button-info">回答列表</button>
					</div>
					<div class="card shadow mb-4">
						<div class="card-body">
							<div class="row">
								<div class="col-lg-2" align="center">用户ID</div>
								<div class="col-lg-7" align="center">回答内容</div>
								<div class="col-lg-3" align="center">更新时间</div>
							</div>
						</div>
					</div>

					<c:forEach var="A" items="${allAnswersOfQuestion}">
						<!-- Basic Card Example -->
						...
						<div class="card shadow mb-4">
							<div class="card-body">
								<div class="row">
									<div class="col-lg-3" align="center">${A.u_id}</div>
									<div class="col-lg-6" align="center">${A.ans_text}</div>
									<div class="col-lg-3" align="center">${A.ans_Time}</div>
	...
	<!--  定义模态框，过渡效果为淡入，id为myModal,tabindex=-1可以禁用使用tab切换，aria-labelledby用于
	引用模态框的标题，aria-hidden=true保持模态框在触发前窗口不可见  -->
			...
			<div class="modal-body">
				...
				<form class="form-horizontal" role="form">
					<input type="text" name="q_id" style="width: 50px;"
						class="form-control well" value="${ques.quesId}" /> <br> <input
						type="text" style="width: 300px; height: 150px;"
						name="answer_text" class="form-control well" placeholder="请输入回答" />
				</form>
			</div>
