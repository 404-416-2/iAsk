		...
		<div id="content-wrapper" class="d-flex flex-column">
			...
			<div id="content">
				...
				<div class="container-fluid" style="width: 60%;">
					...
					<!-- Page Heading -->
					<div align="left">
						<button class="btn button-info">回答列表 (数量: ${answerNum})</button>
					</div>
					<div class="card shadow mb-4">
						<div class="card-body">
							<div class="row">
								<div class="col-lg-2" align="center">问题ID:</div>
								<div class="col-lg-4" align="center">回答内容:</div>
							...
							<div class="card-body">
								<div class="row">
									...
									<div class="col-lg-3" align="center">
										...
										<a
											href="userPages/updateAnswer.jsp?q_id=${Q.q_id}&u_id=${Q.u_id}&a_tx=${Q.ans_text}">
											<button
												class="btn btn-danger">修改</button>
										</a>
									</div>
								</div>
